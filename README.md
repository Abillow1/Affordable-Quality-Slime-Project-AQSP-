...
# Affordable Quality Slime Project (AQSP) PNP Router Branch


This is a seperate branch from the AQSP, it is not for a FBT tracker, but rather it is for the networking side of it for those with limited networking knowlage. This branch is a WIP and not set up uet.
